      ...
      <div className="projectContainer" style={styles.projectContainer}>
        ...
        <section className="section" style={styles.section}>
          ...
          <p className="flex-1 text-justify mt-2">
            ...
            <img src="/jordan/images/bci/imagery.jpg" className="image w-[50vh] h-auto mx-auto mt-5 center" alt="Image loading..."/>
            <br />
            ...
            <img src="/jordan/images/bci/arm.png" className="image w-[50vh] h-auto mx-auto mt-5 center" alt="Image loading..."/>
          </p>
        </section>
        ...
        <section className="section" style={styles.section}>
          ...
          <p className="flex-1 text-justify mt-2">
            ...
            <img src="/jordan/images/bci/eeg_cap.jpg" className="image w-[50vh] h-auto mx-auto mt-5 center" alt="Image loading..."/>
            <br />
            ...
            <img src="/jordan/images/bci/block_diagram.png" className="image w-[100vh] h-auto mx-auto mt-5 center" alt="Image loading..."/>
          </p>
        </section>
        ...
        <section className="section" style={styles.section}>
          ...
          <p className="flex-1 text-justify mt-2">
            ...
            <img src="/jordan/images/bci/stim.png" className="image w-[100vh] h-auto mx-auto mt-5 center" alt="Image loading..."/>
            <br />
            ...
            <img src="/jordan/images/bci/feature_extractor.png" className="image w-[100vh] h-auto mx-auto mt-5 center" alt="Image loading..."/>
            <br />
            ...
            <img src="/jordan/images/bci/feature_classification.png" className="image w-[100vh] h-auto mx-auto mt-5 center" alt="Image loading..."/>
          </p>
        </section>
        ...
        <section className="section" style={styles.section}>
          ...
          <p className="flex-1 text-justify mt-2">
            ...
            <img src="/jordan/images/bci/results1.png" className="image w-[100vh] h-auto mx-auto mt-5 center" alt="Image loading..."/>
          </p>
        </section>
