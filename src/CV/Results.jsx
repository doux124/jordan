      ...
      <div className="projectContainer">
        ...
        <section className="sectionAnimate">
          ...
          <p className="text-justify mt-3">
            <img src="/jordan/images/results3_1.png" className="image w-[100vh] h-auto mb-5"/>
            <div class="flex">
              <img src="/jordan/images/results3_2.png" className="image w-[40vh] h-auto mr-5"/>
              <p className="mt-2">
        ...
        <section className="sectionAnimate">
          ...
          <p className="text-justify mt-3">
            <img src="/jordan/images/results4_1.png" className="image w-[100vh] h-auto mb-5"/>
            ...
            <img src="/jordan/images/results4_2.png" className="image w-[100vh] h-auto mt-5"/>
            <div class="flex">
        ...
        <section className="sectionAnimate">
          ...
          <p className="text-justify mt-3">
            <img src="/jordan/images/results1_1.png" className="image w-[100vh] h-auto mb-5"/>
