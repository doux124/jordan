    ...
    <div>
      ...
      <div className="hobbies-container p-8">
        ...
        <div className="flex justify-center mt-8">
          <Link to="/hobbies/embroidery/" className="hover-scale px-4 py-2 bg-blue-500 text-white rounded-lg">«</Link>
          <Link to="/hobbies/origami/" className="hover-scale px-4 py-2 bg-blue-500 text-white rounded-lg ml-2">1</Link>
          <Link to="/hobbies/embroidery/" className="hover-scale px-4 py-2 bg-blue-500 text-white rounded-lg ml-2">2</Link>
          <div className="hover-scale bg-black ml-2 flex items-center justify-center w-10 h-10 rounded-full">
            <Link to="/hobbies/volunteer/" className="px-4 py-2 bg-blue-500 text-white rounded-lg">3</Link>
          </div>
          <Link to="/hobbies/origami/" className="hover-scale px-4 py-2 bg-blue-500 text-white rounded-lg ml-2">4</Link>
          <Link to="/hobbies/origami/" className="hover-scale px-4 py-2 bg-blue-500 text-white rounded-lg ml-2">»</Link>
        </div>
      </div>
    </div>
  );
