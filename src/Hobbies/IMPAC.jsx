  ...
  return (
    <div style={styles.pageContainer}>
      <div style={styles.projectContainer}>
        <h1 style={styles.header}>Project IMPAC</h1>
        <p>
          (put volunteer and leadership stuff here)
        </p>
        ...
        <section style={styles.section}>
          <h2 style={styles.subHeader}>weeeeee</h2>
        ...
        <div style={styles.flexContainer}>
          <section style={{ ...styles.section, ...styles.flexItem }}>
            <h2 style={styles.subHeader}>aaa</h2>
            <p>
              yap
            </p>
          </section>
