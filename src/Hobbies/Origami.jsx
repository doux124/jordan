      ...
      <div className="hobbies-container p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-4 bg-[#FFECD1] rounded-lg text-white">
            <img src="/jordan/images/origami.jpg" alt="Steak" className="w-full rounded-lg mb-2" />
        ...
        <div className="flex justify-center mt-8">
          ...
          <Link to="/hobbies/origami/" className="hover-scale px-4 py-2 bg-blue-500 text-white rounded-lg ml-2">3</Link>
