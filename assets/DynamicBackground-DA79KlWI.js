import{r as d,j as o}from"./index-BRWUTAvo.js";const h=({title:s,children:r})=>{const[a,m]=d.useState(!1),t=()=>{m(!a)};return o.jsxs("div",{className:"toggle-section",children:[o.jsx("button",{className:"button-78",onClick:t,children:a?`Hide ${s}`:`${s}`}),a&&o.jsx("div",{className:"mt-6 flex-center",children:r})]})},f=({image:s,count:r=20})=>{const[a,m]=d.useState([]);return d.useEffect(()=>{const t=Array.from({length:r},()=>({startX:Math.random()*100,startY:Math.random()*100,rotation:Math.random()*360,moveX:-50+Math.random()*100,moveY:-50+Math.random()*100,duration:15+Math.random()*10})),e=document.createElement("style"),i=t.map((n,c)=>`
